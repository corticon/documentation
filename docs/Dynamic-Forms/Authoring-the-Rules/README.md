...
|**value**|Alphanumeric string|<p>The content of a ReadOnlyText UI Control</p><p></p><p>![Alt text](../../assets/readOnlyText.png)
</p><p></p>|
...
| :-: | :-: |
|<p>**dataTextField**</p><p></p>|<p>Optionally define the key name to use as the display name for this option from dropdown, if its name isn't 'displayName'. Oftentimes this will be the same as the value field.</p><p></p><p>![Alt text](../../assets/dataTextField.png)</p><p></p>|
|**dataValueField**|<p>Optionally define the name of the key whose value should be stored should end user select this option from dropdown, if its name isn't 'value'. Oftentimes this will be the same as the text field. </p><p></p><p>![](../../assets/dataValueField.png)</p><p></p>|
