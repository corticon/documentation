...
-   [Absolute value](https://docs.progress.com/bundle/corticon-rule-language/page/Absolute-value.html)  
    
-   [Add numbers](https://docs.progress.com/bundle/corticon-rule-language/page/Add-numbers.html)  
    
-   [Add strings](https://docs.progress.com/bundle/corticon-rule-language/page/Add-strings.html)  
    
-   [Add days](https://docs.progress.com/bundle/corticon-rule-language/page/Add-days.html)  
    
-   [Add hours](https://docs.progress.com/bundle/corticon-rule-language/page/Add-hours.html)  
    
-   [Add minutes](https://docs.progress.com/bundle/corticon-rule-language/page/Add-minutes.html)  
    
-   [Add months](https://docs.progress.com/bundle/corticon-rule-language/page/Add-months.html)  
    
-   [Add seconds](https://docs.progress.com/bundle/corticon-rule-language/page/Add-seconds.html)  
    
-   [Add years](https://docs.progress.com/bundle/corticon-rule-language/page/Add-years.html)  
    
-   [Associate elements](https://docs.progress.com/bundle/corticon-rule-language/page/Associate-elements.html)  
    
-   [At](https://docs.progress.com/bundle/corticon-rule-language/page/At.html)  
    
-   [Average](https://docs.progress.com/bundle/corticon-rule-language/page/Average.html)  
    
-   [CellValue](https://docs.progress.com/bundle/corticon-rule-language/page/CellValue.html)  
    
-   [Character at](https://docs.progress.com/bundle/corticon-rule-language/page/Character-at.html)  
    
-   [Clone](https://docs.progress.com/bundle/corticon-rule-language/page/Clone.html)  
    
-   [Concatenate](https://docs.progress.com/bundle/corticon-rule-language/page/Concatenate.html)  
    
-   [Contains](https://docs.progress.com/bundle/corticon-rule-language/page/Contains.html)  
    
-   [Day](https://docs.progress.com/bundle/corticon-rule-language/page/Day.html)  
    
-   [Day of week](https://docs.progress.com/bundle/corticon-rule-language/page/Day-of-week.html)  
    
-   [Day of year](https://docs.progress.com/bundle/corticon-rule-language/page/Day-of-year.html)  
    
-   [Days between](https://docs.progress.com/bundle/corticon-rule-language/page/Days-between.html)  
    
-   [Decrement](https://docs.progress.com/bundle/corticon-rule-language/page/Decrement.html)  
    
-   [Disassociate elements](https://docs.progress.com/bundle/corticon-rule-language/page/Disassociate-elements.html)  
    
-   [Divide](https://docs.progress.com/bundle/corticon-rule-language/page/Divide.html)  
    
-   [Div](https://docs.progress.com/bundle/corticon-rule-language/page/Div.html)  
    
-   [Ends with](https://docs.progress.com/bundle/corticon-rule-language/page/Ends-with.html)  
    
-   [Equals ignoring case](https://docs.progress.com/bundle/corticon-rule-language/page/Equals-ignoring-case.html)  
    
-   [Equals when used as an assignment](https://docs.progress.com/bundle/corticon-rule-language/page/Equals-when-used-as-an-assignment.html)  
    
-   [Equals when used as a comparison](https://docs.progress.com/bundle/corticon-rule-language/page/Equals-when-used-as-a-comparison.html)  
    
-   [Equals when using Strings](https://docs.progress.com/bundle/corticon-rule-language/page/Equals-when-using-Strings.html)  
    
-   [Exists](https://docs.progress.com/bundle/corticon-rule-language/page/Exists.html)  
    
-   [Exponent](https://docs.progress.com/bundle/corticon-rule-language/page/Exponent.html)  
    
-   [False](https://docs.progress.com/bundle/corticon-rule-language/page/False.html)  
    
-   [First](https://docs.progress.com/bundle/corticon-rule-language/page/First.html)  
    
-   [First NUMBER](https://docs.progress.com/bundle/corticon-rule-language/page/First-NUMBER.html)  
    
-   [Floor](https://docs.progress.com/bundle/corticon-rule-language/page/Floor.html)  
    
-   [For all](https://docs.progress.com/bundle/corticon-rule-language/page/For-all.html)  
    
-   [Get Milliseconds](https://docs.progress.com/bundle/corticon-rule-language/page/Get-Milliseconds.html)  
    
-   [Greater than](https://docs.progress.com/bundle/corticon-rule-language/page/Greater-than.html)  
    
-   [Greater than or equal to](https://docs.progress.com/bundle/corticon-rule-language/page/Greater-than-or-equal-to.html)  
    
-   [Hour](https://docs.progress.com/bundle/corticon-rule-language/page/Hour.html)  
    
-   [Hours between](https://docs.progress.com/bundle/corticon-rule-language/page/Hours-between.html)  
    
-   [In LIST](https://docs.progress.com/bundle/corticon-rule-language/page/In-LIST.html)  
    
-   [In RANGE](https://docs.progress.com/bundle/corticon-rule-language/page/In-RANGE.html)  
    
-   [Increment](https://docs.progress.com/bundle/corticon-rule-language/page/Increment.html)  
    
-   [Index of](https://docs.progress.com/bundle/corticon-rule-language/page/Index-of.html)  
    
-   [Is integer](https://docs.progress.com/bundle/corticon-rule-language/page/Is-integer.html)  
    
-   [Is empty](https://docs.progress.com/bundle/corticon-rule-language/page/Is-empty.html)  
    
-   [Iterate](https://docs.progress.com/bundle/corticon-rule-language/page/Iterate.html)  
    
-   [Last](https://docs.progress.com/bundle/corticon-rule-language/page/Last.html)  
    
-   [Last NUMBER](https://docs.progress.com/bundle/corticon-rule-language/page/Last-NUMBER.html)  
    
-   [Less than](https://docs.progress.com/bundle/corticon-rule-language/page/Less-than.html)  
    
-   [Less than or equal to](https://docs.progress.com/bundle/corticon-rule-language/page/Less-than-or-equal-to.html)  
    
-   [Logarithm BASE 10](https://docs.progress.com/bundle/corticon-rule-language/page/Logarithm-BASE-10.html)  
    
-   [Logarithm BASE X](https://docs.progress.com/bundle/corticon-rule-language/page/Logarithm-BASE-X.html)  
    
-   [Lowercase](https://docs.progress.com/bundle/corticon-rule-language/page/Lowercase.html)  
    
-   [Matches](https://docs.progress.com/bundle/corticon-rule-language/page/Matches.html)  
    
-   [Maximum value](https://docs.progress.com/bundle/corticon-rule-language/page/Maximum-value.html)  
    
-   [Maximum value COLLECTION](https://docs.progress.com/bundle/corticon-rule-language/page/Maximum-value-COLLECTION.html)  
    
-   [Minimum value](https://docs.progress.com/bundle/corticon-rule-language/page/Minimum-value.html)  
    
-   [Minimum value COLLECTION](https://docs.progress.com/bundle/corticon-rule-language/page/Minimum-value-COLLECTION.html)  
    
-   [Minute](https://docs.progress.com/bundle/corticon-rule-language/page/Minute.html)  
    
-   [Minutes between](https://docs.progress.com/bundle/corticon-rule-language/page/Minutes-between.html)  
    
-   [Mod](https://docs.progress.com/bundle/corticon-rule-language/page/Mod.html)  
    
-   [Month](https://docs.progress.com/bundle/corticon-rule-language/page/Month.html)  
    
-   [Months between](https://docs.progress.com/bundle/corticon-rule-language/page/Months-between.html)  
    
-   [Multiply](https://docs.progress.com/bundle/corticon-rule-language/page/Multiply.html)  
    
-   [Natural logarithm](https://docs.progress.com/bundle/corticon-rule-language/page/Natural-logarithm.html)  
    
-   [New](https://docs.progress.com/bundle/corticon-rule-language/page/New.html)  
    
-   [New unique](https://docs.progress.com/bundle/corticon-rule-language/page/New-unique.html)  
    
-   [Not](https://docs.progress.com/bundle/corticon-rule-language/page/Not.html)  
    
-   [Not empty](https://docs.progress.com/bundle/corticon-rule-language/page/Not-empty.html)  
    
-   [Not equal to](https://docs.progress.com/bundle/corticon-rule-language/page/Not-equal-to.html)  
    
-   [Now](https://docs.progress.com/bundle/corticon-rule-language/page/Now.html)  
    
-   [Null](https://docs.progress.com/bundle/corticon-rule-language/page/Null.html)  
    
-   [Other](https://docs.progress.com/bundle/corticon-rule-language/page/Other.html)  
    
-   [Or](https://docs.progress.com/bundle/corticon-rule-language/page/Or.html)  
    
-   [Random](https://docs.progress.com/bundle/corticon-rule-language/page/Random.html)  
    
-   [Regular expression to replace String](https://docs.progress.com/bundle/corticon-rule-language/page/Regular-expression-to-replace-String.html)  
    
-   [Remove element](https://docs.progress.com/bundle/corticon-rule-language/page/Remove-element.html)  
    
-   [Replace elements](https://docs.progress.com/bundle/corticon-rule-language/page/Replace-elements.html)  
    
-   [Replace String](https://docs.progress.com/bundle/corticon-rule-language/page/Replace-String.html)  
    
-   [Round](https://docs.progress.com/bundle/corticon-rule-language/page/Round.html)  
    
-   [Second](https://docs.progress.com/bundle/corticon-rule-language/page/Second.html)  
    
-   [Seconds between](https://docs.progress.com/bundle/corticon-rule-language/page/Seconds-between.html)  
    
-   [Size of collection](https://docs.progress.com/bundle/corticon-rule-language/page/Size-of-collection.html)  
    
-   [Size of string](https://docs.progress.com/bundle/corticon-rule-language/page/Size-of-string.html)  
    
-   [Sorted by](https://docs.progress.com/bundle/corticon-rule-language/page/Sorted-by.html)  
    
-   [Sorted by descending](https://docs.progress.com/bundle/corticon-rule-language/page/Sorted-by-descending.html)  
    
-   [Starts with](https://docs.progress.com/bundle/corticon-rule-language/page/Starts-with.html)  
    
-   [SubSequence](https://docs.progress.com/bundle/corticon-rule-language/page/SubSequence.html)  
    
-   [Substring](https://docs.progress.com/bundle/corticon-rule-language/page/Substring.html)  
    
-   [Subtract](https://docs.progress.com/bundle/corticon-rule-language/page/Subtract.html)  
    
-   [Sum](https://docs.progress.com/bundle/corticon-rule-language/page/Sum.html)  
    
-   [Today](https://docs.progress.com/bundle/corticon-rule-language/page/Today.html)  
    
-   [To date Casting a dateTime to a date](https://docs.progress.com/bundle/corticon-rule-language/page/To-date-Casting-a-dateTime-to-a-date.html)  
    
-   [To dateTime Casting a date to a dateTime](https://docs.progress.com/bundle/corticon-rule-language/page/To-dateTime-Casting-a-date-to-a-dateTime.html)  
    
-   [To dateTime Casting a string to a dateTime](https://docs.progress.com/bundle/corticon-rule-language/page/To-dateTime-Casting-a-string-to-a-dateTime.html)  
    
-   [To dateTime Casting a time to a dateTime](https://docs.progress.com/bundle/corticon-rule-language/page/To-dateTime-Casting-a-time-to-a-dateTime.html)  
    
-   [To dateTime Timezone offset](https://docs.progress.com/bundle/corticon-rule-language/page/To-dateTime-Timezone-offset.html)  
    
-   [To decimal](https://docs.progress.com/bundle/corticon-rule-language/page/To-decimal.html)  
    
-   [To integer](https://docs.progress.com/bundle/corticon-rule-language/page/To-integer.html)  
    
-   [To string](https://docs.progress.com/bundle/corticon-rule-language/page/To-string.html)  
    
-   [To time Casting a dateTime to a time](https://docs.progress.com/bundle/corticon-rule-language/page/To-time-Casting-a-dateTime-to-a-time.html)  
    
-   [Trend](https://docs.progress.com/bundle/corticon-rule-language/page/Trend.html)  
    
-   [Trim spaces](https://docs.progress.com/bundle/corticon-rule-language/page/Trim-spaces.html)  
    
-   [True](https://docs.progress.com/bundle/corticon-rule-language/page/True.html)  
    
-   [Uppercase](https://docs.progress.com/bundle/corticon-rule-language/page/Uppercase.html)  
    
-   [Week of month](https://docs.progress.com/bundle/corticon-rule-language/page/Week-of-month.html)  
    
-   [Week of year](https://docs.progress.com/bundle/corticon-rule-language/page/Week-of-year.html)  
    
-   [Year](https://docs.progress.com/bundle/corticon-rule-language/page/Year.html)  
    
-   [Years between](https://docs.progress.com/bundle/corticon-rule-language/page/Years-between.html)
